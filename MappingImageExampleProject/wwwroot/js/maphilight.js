        ...
        if (c) {
            ...
            (p = function (t, i, e, a, o) {
                ...
                if (a.shadow) {
                    ...
                    h || (h = "outside" == a.shadowPosition ? "fill" : "stroke"),
                        "stroke" == h ? ((r.strokeStyle = "rgba(0,0,0,1)"), r.stroke()) : "fill" == h && ((r.fillStyle = "rgba(0,0,0,1)"), r.fill()),
                        r.restore(),
                        "outside" == a.shadowPosition && (r.save(), b(r, i, e), (r.globalCompositeOperation = "destination-out"), (r.fillStyle = "rgba(0,0,0,1);"), r.fill(), r.restore());
                }
                r.save(),
                    b(r, i, e),
                    a.fill && ((r.fillStyle = v(a.fillColor, a.fillOpacity)), r.fill()),
                    a.stroke && ((r.strokeStyle = v(a.strokeColor, a.strokeOpacity)), (r.lineWidth = a.strokeWidth), r.stroke()),
                    r.restore(),
            ...
            (f = function (t) {
                ...
                (p = function (t, i, e, a, o) {
                    ...
                    (r = '<v:fill color="#' + a.fillColor + '" opacity="' + (a.fill ? a.fillOpacity : 0) + '" />'),
                        (s = a.stroke ? 'strokeweight="' + a.strokeWidth + '" stroked="t" strokecolor="#' + a.strokeColor + '"' : 'stroked="f"'),
        ...
        (d.fn.maphilight = function (h) {
            return (
                ...
                this.each(function () {
                    ...
                    if (
                        ((r = d.extend({}, h, !!d.metadata && e.metadata(), e.data("maphilight"))), (i = e.get(0).getAttribute("usemap")) && ((s = d('map[name="' + i.substr(1) + '"]')), e.is('img,input[type="image"]') && i && 0 < s.length))
                    ) {
                        ...
                        this.src.replace(/[\n\r]/g, ""),
                            ...
                            r.wrapClass && (!0 === r.wrapClass ? t.addClass(d(this).attr("class")) : t.addClass(r.wrapClass)),
